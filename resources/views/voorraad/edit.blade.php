...
<div class="container" style="max-width: 700px;">
    ...
    {{-- Succesmelding --}}
    @if(session('success'))
        <div class="alert" style="background-color: #d4edda; border: none; color: #333; border-radius: 4px;" role="alert">
            {{ session('success') }}
        </div>
    @endif
...
(function () {
    ...
    function updateVoorraad() {
        const uitgeleverd = aantalInput.value === '' ? 0 : (parseInt(aantalInput.value) || 0);
