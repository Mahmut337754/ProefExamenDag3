...
<body>
    ...
    <div class="login-card card">
        ...
        <div class="card-body p-4">
            ...
            {{-- Testaccounts --}}
            <div class="mt-4 p-3 rounded" style="background:#f8f9fa; border:1px solid #dee2e6; font-size:0.8rem;">
                <p class="fw-semibold mb-2 text-muted"><i class="bi bi-info-circle me-1"></i>Testaccounts</p>
                <table class="table table-sm table-borderless mb-0" style="font-size:0.78rem;">
                    <thead><tr class="text-muted"><th>Rol</th><th>E-mail</th><th>Wachtwoord</th></tr></thead>
                    <tbody>
                        <tr><td><span class="badge" style="background:#2c3e50">Manager</span></td><td>manager@voedselbank.nl</td><td>password</td></tr>
                        <tr><td><span class="badge" style="background:#e87722">Medewerker</span></td><td>medewerker@voedselbank.nl</td><td>password</td></tr>
                        <tr><td><span class="badge bg-secondary">Vrijwilliger</span></td><td>vrijwilliger@voedselbank.nl</td><td>password</td></tr>
                    </tbody>
                </table>
            </div>
